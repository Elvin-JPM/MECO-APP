...
def insert_datos(data_to_insert):
    try:
        ...
        with engine.connect() as connection:
            ...
            # Modified query to also fetch ORIGEN column
            ...
            # Identify records to insert and update
            records_to_insert = []
            records_to_update = []
            ...
            if not df_to_update.empty:
                print("Sample record to update:")
                print(df_to_update.iloc[0])
                
                # Using text() to create a SQL expression with bind parameters
                ...
                connection.commit()
                print(f"\nSuccessfully updated {len(df_to_update)} existing records")
            else:
